      ...
      <div className='flex justify-center w-full flex-wrap'>
        ...
        <a href='https://discord.gg/cuRPSYVR85' target='__blank'>
          <svg
            ...
            viewBox="0 0 645 517"
            className={darkMode ?
              ('text-white w-6 h-6 mx-8 mb-10  md:w-10 md:mx-10 hover:text-amber-400 hover:scale-150 transition-all ease-in-out duration-300')
              :
              ('text-white w-6 h-6 mx-8 mb-10 md:w-10 md:mx-10 hover:text-violet-400 hover:scale-150 transition-all ease-in-out duration-300')}
          >
            <path
              fill="currentColor"
